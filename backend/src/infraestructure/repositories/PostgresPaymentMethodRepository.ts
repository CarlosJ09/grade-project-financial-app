...
export class PostgresPaymentMethodRepository implements IPaymentMethodRepository {
    ...
    async findAll(): Promise<PaymentMethod[]> {
        ...
        return paymentMethods.map(paymentMethod => new PaymentMethod(
            paymentMethod.id,
    ...
    async update(id: string, entity: Partial<Omit<PaymentMethod, 'id' | 'createdAt' | 'updatedAt'>>): Promise<PaymentMethod> {
