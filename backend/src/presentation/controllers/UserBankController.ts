...
export class UserBankController extends BaseController {
    ...
    async getAll(req: Request, res: Response) {
        return this.handleGetAll(req, res, this.getAllUserBanks, UserBankResponseDto);
    }

    async getById(req: Request, res: Response) {
        return this.handleGetById(req, res, this.getUserBankById, UserBankResponseDto, 'UserBank');
    }

    async create(req: Request, res: Response) {
        return this.handleCreate(req, res, this.createUserBank, UserBankResponseDto, 'UserBank');
    }

    async update(req: Request, res: Response) {
        return this.handleUpdate(req, res, this.updateUserBank, UserBankResponseDto, 'UserBank');
    }
