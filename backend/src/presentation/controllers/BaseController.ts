...
export abstract class BaseController {
     ...
     */
    protected internalServerError(res: Response, message: string = 'Internal server error'): Response {
     ...
     */
    protected validateRequiredParams(req: Request, requiredParams: string[]): string[] {
